...
class SocnetshopTwitter :

    def __init__(self):

        self.CONSUMER_KEY = '3SU7oFEsXDuRSEA570yng' 
        self.CONSUMER_SECRET = 'K9oac1nuBANhiQpx5mjKOIjOEfHNRl8XCfrYCGfTCrg'
    ...
    def authorize (self):
        """" final authorization --> needs this to access inforamtion"""
    ...
    def update_status(self,status):
        ...
        #updating the status of the authenticated user
